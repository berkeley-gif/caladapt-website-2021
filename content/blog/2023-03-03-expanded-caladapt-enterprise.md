...
## Data access
Preliminary climate data that may support the Fifth Assessment is available for California. This data is aligned with the next generation climate models from <a href="ttps://www.wcrp-climate.org/wgcm-cmip/wgcm-cmip6" target="_blank">Coupled Model Intercomparison Project Phase 6</a>(h) (CMIP6) and has been downscaled to higher spatial resolutions ranging from 3 to 45 kms. Learn more <a href="/blog/climate-data-access" target="_blank">about this data and how to access it</a>.
