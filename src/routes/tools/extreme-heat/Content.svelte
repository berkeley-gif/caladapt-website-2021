          ...
          <p>
            ...
            <TooltipDefinition>
              <div slot="tooltip">
                <p style="font-size:0.875rem;">
                  The default threshold temperature for this location is {$thresholdStore}
                  °F. It is defined as the 98th percentile value of historical daily
                  maximum/minimum temperatures (from 1961–1990, between April and
                  October).
                </p>
                <p style="font-size:0.875rem;">
                  Change this value in the Settings Panel under Threshold
                  Temperature.
                </p>
              </div>
              {$thresholdStore} °F
            ...
            {#if $indicator.id === "waves"}
              ...
              <TooltipDefinition>
                <div slot="tooltip">
                  <p style="font-size:0.875rem;">
                    By default, a heat wave is defined based on a period of 4
                    consecutive extreme heat days/warm nights when the daily
                    max/min temperature is above the extreme heat threshold.
                    Each 4 day/night period is counted, so that if extreme
                    temperatures persist for 10 consecutive days/nights, it
                    counts as 2 Heat Waves.
                  </p>
                  <p style="font-size:0.875rem;">
                    Change this length in the Settings Panel under Heat Wave
                    Length.
                  </p>
                </div>
                {$periodStore} days.
