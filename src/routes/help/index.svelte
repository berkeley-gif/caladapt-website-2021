...
<section>
        ...
        <div class="bx--col-lg-4" style="padding:1rem;">
          <div class="card shadow lift">
            <div class="card-body" style="padding: 1.5rem 1rem;text-align:center;">
              ...
              <a class="stretched-link" href='/help/{category.slug}/' title='Explore »'> </a>
            </div>
          </div>
        </div>
      {/each}
  ...
  <div class="bx--row help-footer">
    <div class="bx--col-lg-8 bx--col-md-4">
      ...
      <p>
        Email us at <a href="mailto:support@cal-adapt.org">support@cal-adapt.org</a>.
      </p>
    </div>
    <div class="bx--col-lg-8 bx--col-md-4">
      <h4>
      ...
      <p>
        Read <a href="https://berkeley-gif.github.io/caladapt-docs/" target="_blank">Cal-Adapt API Documentation</a>.
      </p>
    </div>
  </div>
</section>
