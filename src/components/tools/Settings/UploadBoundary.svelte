<script>
  ...
  // Helpers
  import { handleXHR, handle, convertFileToGeojson, validateShape} from './../../../helpers/utilities';
  ...
  async function processUpload(file) {
    ...
    if (geojsonError) {
      ...
      fileUploadProps.errorBody = 'Unable to display shape on map. File is valid and will be used to display spatially aggregated data.';
    }
